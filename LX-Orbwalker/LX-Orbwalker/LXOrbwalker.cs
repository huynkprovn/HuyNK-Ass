...
namespace LX_Orbwalker
{
	public class LXOrbwalker
	{
		...
		private static Obj_AI_Base GetBestHeroTarget()
		{
			...
			return hitsToKill < 4 ? killableEnemy : LeagueSharp.Common.TargetSelector.GetTarget(GetAutoAttackRange() + 100, LeagueSharp.Common.TargetSelector.DamageType.Physical);
		}
