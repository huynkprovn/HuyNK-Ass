...
namespace HuyNKSeries
{
    ...
    public class HuyNKOrbwalker
    {
        ...
        private static AttackableUnit GetBestHeroTarget()
        {
            ...
            return hitsToKill <= 3 ? killableEnemy : LeagueSharp.Common.TargetSelector.GetTarget(GetAutoAttackRange(), LeagueSharp.Common.TargetSelector.DamageType.Physical);
        }
