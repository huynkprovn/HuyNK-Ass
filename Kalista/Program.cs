...
namespace Kalista
{
    public class Program
    {
        ...
        private static void Spellbook_OnCastSpell(Obj_AI_Base spellbook, SpellbookCastSpellEventArgs args)
        {
            // Avoid stupic Q casts while jumping in mid air!
            if (spellbook.IsMe && args.Slot == SpellSlot.Q && player.IsDashing())
            {
