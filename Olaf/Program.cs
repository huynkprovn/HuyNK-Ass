...
namespace HuyNKOlaf
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Orbwalker submenu
            Config.AddSubMenu(new Menu("Thả diều", "Orbwalking"));

            //Load the orbwalker and add it to the submenu.
            Orbwalker = new Orbwalking.Orbwalker(Config.SubMenu("Orbwalking"));

            Config.AddSubMenu(new Menu("Combat", "Combo"));
            Config.SubMenu("Combo").AddItem(new MenuItem("UseQCombo", "Dùng Q")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("UseWCombo", "Dùng W")).SetValue(true);
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("UseQHarass", "Dùng Q").SetValue(false));
            Config.SubMenu("Harass").AddItem(new MenuItem("UseQ2Harass", "Dùng  Q Ngắn").SetValue(true));
            Config.SubMenu("Harass").AddItem(new MenuItem("UseEHarass", "Dùng E").SetValue(true));
            Config.SubMenu("Harass").AddItem(new MenuItem("Minman", "Tiết kiệm mana khi rỉa").SetValue(new Slider(30, 100, 0)));
